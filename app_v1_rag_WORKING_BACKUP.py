...
from orchestrator_v1 import VaultZeroOrchestrator
...
"""
    ...
    try:
        # Call Claude API - Using HAIKU for speed!
        client = anthropic.Anthropic(api_key=os.getenv("ANTHROPIC_API_KEY"))
        
        # Always return text (no streaming to avoid generator issues)
...
# Header
st.markdown('<div class="main-header">🔒 VaultZero 1.0</div>', unsafe_allow_html=True)
st.markdown('<div class="sub-header">AI-Powered Zero Trust Maturity Assessment with RAG</div>', unsafe_allow_html=True)
...
<div style='text-align: center; color: #666;'>
    <p>🔒 <strong>VaultZero 1.0</strong> | AI-Powered Zero Trust Assessment with RAG</p>
